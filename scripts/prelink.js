try {
    ...
    var PACKAGE_GRADLE = process.cwd() + '/node_modules/react-native-amqp-lib/android/build.gradle'
    ...
    function checkVersion() {
        console.log('react-native-amqp-lib checking app version ..');
        return parseFloat(/\d\.\d+(?=\.)/.exec(package.dependencies['react-native']));
    }

} catch(err) {
  console.log(
    '\033[95mreact-native-amqp-lib\033[97m link \033[91mFAILED \033[97m\nCould not automatically link package :'+
    err.stack)
}
